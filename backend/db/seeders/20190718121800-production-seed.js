...
module.exports = {
    ...
    return queryInterface.bulkInsert(
      ...
      [
        ...
        },
        {
          ...
          pending: false,
          type: "ADMIN",
          token: "bbf86843-a2ab-4687-b1be-55fb4e564f12",
          tokenExpiration: tomorrow,
          newOwner: false,
          createdAt: new Date(),
          updatedAt: new Date()
        },
        {
          ...
          email: "REMOVED@gmail.com",
          password: bcrypt.hashSync("REMOVED", 12),
          name: "Thom Tessandori",
          pending: false,
          type: "ADMIN",
          token: "7c3096e4-9a8b-4c94-9685-522be66661a1",
          tokenExpiration: tomorrow,
          newOwner: false,
          createdAt: new Date(),
          updatedAt: new Date()
  ...
  down: (queryInterface, Sequelize) => {
    queryInterface.bulkDelete("Choices", null, {});
    queryInterface.bulkDelete("Questions", null, {});
    queryInterface.bulkDelete("Strains", null, {});
